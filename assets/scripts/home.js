...
function updateButtons() {
  document.getElementById("leftButtonLanding").disabled =
    currentIndexLanding === 0;
  document.getElementById("rightButtonLanding").disabled =
    currentIndexLanding === 2;
